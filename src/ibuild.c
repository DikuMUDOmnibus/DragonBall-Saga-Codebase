...
void fill_in_obj_page( CHAR_DATA * ch, OBJ_INDEX_DATA * idx, char page )
{
  ...
  switch ( page )
  {
    ...
    case 'e':
      ...
      obj_page_e_data[46].data = IS_OBJ_STAT( idx, ITEM_ANTI_REPLOID ) ? check : space;
      obj_page_e_data[47].data = IS_OBJ_STAT( idx, ITEM_ONLY_REPLOID ) ? check : space;
      obj_page_e_data[48].data = IS_OBJ_STAT( idx, ITEM_ANTI_MUTANT ) ? check : space;
      obj_page_e_data[49].data = IS_OBJ_STAT( idx, ITEM_ONLY_MUTANT ) ? check : space;
      break;
    case 'd':
    ...
    case 'b':
      ...
      obj_page_b_data[36].data = ( ( idx->item_type == ITEM_PIECE ) ? check : space );
