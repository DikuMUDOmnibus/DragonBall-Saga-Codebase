 ...
 *
	...
	*
      ...
      for( iClass = 0; iClass < MAX_CLASS; iClass++ )
      {
        ...
        if( (iClass > 8 && iClass < 27 && iClass <= 31 && iClass <= 36 && iClass <= 37 && iClass <= 39) ||
	    iClass == 32 ||
	    iClass == 33 ||
	    iClass == 35 ||
	    iClass == 39) {
        ...
        char letters[17] = "abcdefghijklmnopq";
    ...
    case CON_GET_NEW_CLASS:
       ...
       */
      if( iClass != 27 && iClass != 28 && iClass != 29 && iClass != 30 && iClass != 31 && iClass != 34 && iClass != 36 && iClass != 37 && iClass != 38)
        if( iClass > 8
