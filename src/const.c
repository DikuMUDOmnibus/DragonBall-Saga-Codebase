...
*/
{
  ...
  "yardratian", "fierian", "hylian", "ant", "ape", "baboon", "bat", "bear", "bee", 
  "beetle", "boar", "bugbear", "cat", "dog", "dragon", "ferret", "fly", "gargoyle",
...
char *const hair_color[MAX_HAIR] = {
  "white", "platinum blonde", "orange", "blonde",
...
char *s_1337_messages[28] = {
  ...
  "*** ANIHATE LOLZ ***", "**** FUKUPd00d ****", "**** OMG UZ RAPEN HEEM ****"
};
