...
/*//T1*/
    case 'a':
      ...
      if( !str_cmp( name, "do_active_form" ) )
        return do_active_form;
...
//        return do_bank;
    ...
    case 'o':
      if( !str_cmp( name, "do_omega" ) )
        return do_omega;
      if( !str_cmp( name, "do_omega_form" ) )
        return do_omega_form;
      ...
      break;
    case 'p':
      if( !str_cmp( name, "do_power_form" ) )
        return do_power_form;
      if( !str_cmp( name, "do_proto_form" ) )
        return do_proto_form;
...
//    if( skill == do_trust           ) return "do_trust";
  ...
  if( skill == do_aiminglaser )
    return "do_aiminglaser";
  if( skill == do_active_form )
    return "do_active_form";
  if( skill == do_power_form )
    return "do_power_form";
  if( skill == do_proto_form )
    return "do_proto_form";
  if( skill == do_omega_form ) // Reploid End
    return "do_omega_form";
